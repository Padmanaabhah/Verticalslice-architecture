...
namespace TravelInspiration.API.Shared.Domain.Configurations
{
    public sealed class ItenaryConfiguration : IEntityTypeConfiguration<Itinerary>
    {
